<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="KategoriDuzenle.aspx.cs" Inherits="BuyuNot.AdminPanel.KategoriDuzenle" %>
    ...
    <div class="formTasiyici">
        ...
        <div class="formIcerik">
            ...
            <div class="satir satirbosluk">
                <asp:LinkButton ID="lbtn_duzenle" runat="server"
                    CssClass="İslemButon"
                    OnClick="lbtn_duzenle_Click">Kategori Düzenle</asp:LinkButton>
            </div>
        </div>
    </div>
</asp:Content>
